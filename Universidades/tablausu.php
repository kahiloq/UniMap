...
else
{
 $sqlusu = mysqli_query($conn, "SELECT * FROM usuarios ORDER BY nom ASC LIMIT " . (($pagina - 1) * $filasmax)  . "," . $filasmax);
	...
	<a href="tablausu.php" class="BotonesUsuarios">Inicio de la tabla</a>
...
if ($_GET['pag'] > 1) {
 ?>
<a class="BotonesUsuarios" href="tablausu.php?pag=<?php echo $_GET['pag'] - 1; ?>">Anterior</a>
<?php
} 
else 
{
...
?>
<a class="BotonesUsuarios" href="tablausu.php?pag=<?php echo $_GET['pag'] + 1; ?>">Siguiente</a>
<?php
} else {
?>
...
?>
<a class="BotonesUsuarios" href="tablausu.php?pag=2">Siguiente</a>
<?php
}
?>
</div>
